...
静态应用安全测试（SAST）也称代码安全审计，即对应用进行白盒测试，也可以人工+工具结合方式进行  。
...
Micro Focus Fortify：地址：http://www.fortify.net/ 

Checkmarx：地址：https://www.checkmarx.com/ 

Veracode Static Analysis：地址：https://www.veracode.com/products/binary-static-analysis-sast

 Synopsys Coverity 静态应用安全测试：地址：https://www.synopsys.com/software-integrity/security-testing/static-analysis-sast.html
...
动态应用安全测试（DAST），即对应用进行黑盒测试，即常规的web漏洞扫描     
...
交互应用安全测试（IAST）  作用于应用内部的安全漏洞测试，需要人工参与测试整个流程，测试、开发人员也进行进来，实现一边进行功能测试，然后自动化进行安全测试。   

### 商业产品：
国内：

默安-雳鉴IAST、新思-Seeker软件、开源网安-SecZone VulHunter、悬镜-灵脉AI-IAST渗透测试平台
